...
$(document).ready(function () {
    (function () {
        ...
        var local = {
            ...
            dblClickArray: [' - create new reference dot for Bezier curves. ', 
                            ' - создать новую опорную точку для кривых Безье.', 
                            ' - створити нову опорну точку для кривих Безьє. '],
            deleteDotArray: [' - delete a reference dot. ', 
                             ' - удалить опорную точку. ', 
                             ' - знищити опорну точку. '],
            dragDotArray: [' a dot. ', 
                           ' точку. ', 
                           ' точку. '],
            ...
            sheetArray: ['Sheet', 
                         'Лист', 
                         'Лист'],
            uploadDummyArray: ['Upload Dummy', 
                               'Загрузить макет', 
                               'Завантажити макет'],
            deleteDummyArray: ['Delete Dummy', 
                               'Удалить макет', 
                               'Знищити макет'],
            ...
            curveArray: ['Tape', 
                         'Лента', 
                         'Стрічка'],
            featherAngleArray: ['Feather Angle, degree: ', 
                                'Угол наклона пера, град: ', 
                                'Кут нахилу пера, град: '],
            widthArray: ['Width: ', 
                         'Ширина: ', 
                         'Ширина: '],
            aboutArray: ['About', 
