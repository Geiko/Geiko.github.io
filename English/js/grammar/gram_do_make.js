...
[
	{	
		task : `1. Когда используется to do?`, 			
...
Часто со словами something, nothing, anything, everything…
...
to do one’s hair/nails – делать прическу/маникюр`
	...
	{	
		task : `2. Когда используется to make?`, 			
		
		solution : 
`to make, используется в случаях, когда подразумевается создание чего-то, построение или творение... 
...
make one’s bed – в значении „убрать постель”`
	...
	{	
		task : `добиться, достигнуть цели`, 	solution : `do the trick`    
	},
	{	
		task : `чистить пылесосом`, 	solution : `do the vacuuming`    
	},
	{	
		task : `вычислять, подсчитывать`, 	solution : `do the math`    
	},
	{	
		task : `сделать уборку`, 	solution : `do cleaning`    
	},
	{	
		task : `работать (кем-л.)`, 	solution : `do something for a living`    
	},
	{	
		task : `делать так`, 	solution : `do so`    
	},
	{	
	...
	{	
		task : `разгадывать загадку`, 	solution : `do a crossword / jigsaw puzzle`    
	},
	{	
		task : `работать сверхурочно`, 	solution : `do overtime`    
	},
	{	
	...
	{	
		task : `проводить урок`, 	solution : `do a lesson`    
	},
	{	
		task : `хорошо выполнить работу`, 	solution : `do a good job`    
	},
	{	
		task : `пройти курсы`, 	solution : `do a course`    
	},
	{	
		task : `отрыгивать`, 	solution : `do a burp`    
	},
	{	
		task : `ничего не делать`, 	solution : `do nothing`    
	},
	{	
		task : `Сегодня я ничего не делаю.`, 	solution : `I’m not doing anything today.`
	},
	{	
		task : `Он делает все для его мамы.`, 	solution : `He does everything for his mother.`
	},
	{	
		task : `Она ничего не делает.`, 	solution : `She’s doing nothing.`
	},
	{	
	...
	{	
		task : `делать работу по дому`, solution : `do the housework`
	},
	{	
		task : `делать чью-то работу`, 	solution : `do one’s job`
	},
	{	
	...
	{	
		task : ` сделать одолжение`, solution : `do a favour`
	},
	{	
		task : ` пойти на пользу; принести пользу`, solution : `do good`
	},
	{	
		task : ` пойти во вред; принести вред; причинить вред`, solution : `do harm`
	},
	{	
		task : ` отбывать срок (в тюрьме)`, solution : `do time (to go to prison)`
	},
	{	
		task : ` хорошо преуспевать (в чем-либо); хорошо удаваться (о чем-либо); и т.д.`, solution : `do well`
	},
	{	
	...
	{	
		task : ` сделать выбор`, solution : `make a choice`
	},
	{	
	...
	{	
		task : ` приложить усилие`, solution : `make an effort`
	},
	{	
	...
	{	
		task : ` сделать ход`, solution : `make a move`
	},
	{	
	...
	{	
		task : ` издать звук`, solution : `make a sound`
	},
	{	
	...
	{	
		task : `приготовить завтрак`, solution : `make breakfast`
	},
	{	
		task : `приготовить ланч`, solution : `make lunch`
	},
	{	
		task : `приготовить обед`, solution : `make dinner`
	},
	{	
		task : ` приготовить еду`, 	solution : `make food = to cook \n если идет речь о еде, используйте всегда make`
	},
	{	
		task : ` заварить чаек :)`, solution : `make a cup of tea`
	},
	{	
		task : `скроить платье`, solution : `make a dress`
	},
	{	
		task : `сыр сделан из молока`, solution : `Cheese is made of milk`
	},
	{	
		task : `Этот телефон изготовлен в Китае`, solution : `This phone is made in China`
	},
	{	
		task : ``, solution : `make `
	},
	...
	{	
		task : `копировать, снять копию`, solution : `make a copy`
	},
	{	
		task : `выполнять работу в срок`, solution : `make a/the deadline`
	},
	{	
	...
	{	
		task : `снять фильм`, solution : `make a movie`
	},
	{	
	...
	{	
		task : `заниматься сексом`, solution : `make love`
	},
	{	
		task : `унести, украсть`, solution : `make off with`
	},
	{	
		task : `удаваться, составить (счет), разобрать, целоваться`, solution : `make out`
	},
	{	
		task : `мириться, заключать мир`, solution : `make peace`
	},
	{	
	...
	{	
		task : `убеждаться`, solution : `make sure`
	},
	{	
	...
	{	
		task : `выдумывать, помириться, составить`, solution : `make up`
	},
	{	
		task : `принимать решение`, solution : `make up one's mind`
	}
]